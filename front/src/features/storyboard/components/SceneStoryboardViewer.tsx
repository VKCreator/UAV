...
import type { Point, Polygon, TrajectoryPoint } from "../../../types/scene.types";
...
const SceneViewer: FC<SceneViewerProps> = ({
  imageData,
  points = [],
  pointsRecommended = [],
  obstacles = [],
  ...
  const [image] = useImage(imageData ? imageData.imageUrl : "");
  ...
  return (
    <Box bgcolor="#ffffff" width={STAGE_WIDTH}>
      <Stage
        ref={stageRef}
        width={STAGE_WIDTH}
        height={STAGE_HEIGHT}
